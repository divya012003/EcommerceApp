                ...
                <div className="row payment">
                    <div className="col-md-6">
                        <div className="payment-method">
                            <p>We Accept:</p>
                            <img src="images/img/payment-method.png" alt="Payment Method" />
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="payment-security">
                            <p>Secured By:</p>
                            <img src="images/img/godaddy.svg" alt="Payment Security" />
                            <img src="images/img/norton.svg" alt="Payment Security" />
                            <img src="images/img/ssl.svg" alt="Payment Security" />
                        </div>
                    </div>
                </div>
            </div>
